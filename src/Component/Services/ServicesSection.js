...
import { FaFacebook, FaGoogle, FaInstagram, FaSnapchat, FaLinkedin, FaHtml5, FaCss3Alt, FaJs, FaWordpress, FaShopify, FaPhp, FaPalette, FaDatabase, FaReact, FaNodeJs, FaAws } from 'react-icons/fa';
    ...
    const servicesData = {
      'digital-marketing': {
        ...
        features: [
          ...
          { name: 'Snapchat Ads', icon: FaSnapchat },
      ...
      'web-development': {
        ...
        features: [
          ...
          { name: 'Magento', icon: FaAws }, // Using AWS as placeholder for Magento
          { name: 'PHP', icon: FaPhp }
        ],
      ...
      'graphic-design': {
        ...
        icon: '🎨',
        features: [
          { name: 'Post Design', icon: FaPalette },
          { name: 'Logo Design', icon: FaPalette },
          { name: 'Carousel Design', icon: FaPalette },
          { name: 'Brand Identity Design', icon: FaPalette }
        ],
      ...
      >
        ...
        <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 md:p-8 transition-all duration-300 group-hover:border-green-400/30">
          <div className="flex items-center gap-4 mb-6">
            <div className={`text-3xl p-4 rounded-xl bg-gradient-to-br ${currentService.color}`}>
              {currentService.icon}
            </div>
            <h3 className="text-xl md:text-2xl font-bold text-white">{currentService.title}</h3>
          </div>

          {/* Fixed Feature List with Icons */}
            ...
            {currentService.features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <IconComponent className="text-lg opacity-60" />
                </motion.li>
              );
            })}
          </ul>
